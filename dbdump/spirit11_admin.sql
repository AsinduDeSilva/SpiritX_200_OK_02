...
CREATE TABLE `admin` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKkbar5f393alqgsi12gw0aphh7` (`credentials_id`),
  CONSTRAINT `FKdyc6qxjq1bbuy9bywiajgvhtq` FOREIGN KEY (`credentials_id`) REFERENCES `credentials` (`id`)
...
INSERT INTO `admin` VALUES (2,1,'Admin');
